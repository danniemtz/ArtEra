      ...
      <main className="home-main">
        ...
        <section className="hero-wrapper">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <Link to="/browse">
                <button className="search-btn">Start Browsing</button>
              </Link>
            </div>
            <img src={`${publicPath}/hero_image.png`} alt="Artwork" />
          </div>
        </section>
        ...
        <div className="steps-wrapper" id="how-it-works">
          ...
          <div className="steps-row">
            <div className="step">
              <img src={`${publicPath}/arrow.png`} alt="Pick a Filter" />
              <h4>Pick a Filter</h4>
              <p>Choose between Era, Artist, Culture, or Title</p>
            </div>

            <img src={`${publicPath}/swiggly.png`} alt="swiggle" className="swiggle" />

            <div className="step">
              <img src={`${publicPath}/search_icon.png`} alt="Type in Search" />
            ...
            <div className="step">
              <img src={`${publicPath}/browse_icon.png`} alt="Browse" />
        ...
        <section className="prototype-goals" id="goals">
          ...
          <div className="goals-content">
            ...
            <img src={`${publicPath}/art_2.png`} alt="Art example" />
          </div>
        </section>
